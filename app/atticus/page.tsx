    ...
    <main className="min-h-screen bg-paper">
      <div className="max-w-2xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="mt-10 border border-rule bg-paper-subtle rounded-sm p-6">
          <div className="eyebrow text-muted">Chat coming soon</div>
          <p className="text-sm text-ink mt-2">
            The full chat is wrapping up final testing. In the meantime, leave your number
            and Debbie or Ashley will text you back tonight — even if it&rsquo;s after hours.
          </p>
          <Link
            href="/contact"
