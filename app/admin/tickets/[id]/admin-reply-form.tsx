    ...
    <form onSubmit={handleSubmit} className="card p-5 space-y-3">
      <div className="flex items-center justify-between gap-3">
        <div className="eyebrow">
          {internal ? "Internal note (not visible to student)" : "Reply to student"}
        </div>
      ...
      <div className="text-xs text-subtle">
        Replies post into the student&rsquo;s portal at <code>/portal/tickets</code>. The student sees it next time they sign in.
      </div>
