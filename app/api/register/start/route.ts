 ...
 *   - it does NOT email anything and does NOT mark anything paid; it only
 *     opens an unsigned agreement. Signing still goes through the existing
 *     /api/enroll/[token]/sign route with all of its validation.
 *
