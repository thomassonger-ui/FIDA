...
export const entryLevelDetail: CourseDetail = {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: b(
        "Nothing until you've toured — book a campus tour first. Then three stages. First, a $150 non-refundable registration fee paid online once you've decided to enroll. Second, a $750 seat deposit once your application and enrollment agreement are in — that's what holds your seat, and your $150 registration counts toward it, so $600 is due then. Third, the $9,100 balance on an interest-free in-house plan ($1,516.66/month over 6 months or $1,137.50/month over 8 months) or an 18-month plan through TFC Tuition Financing. We accept card, ACH, check, and cash. Eligible military members and first responders receive a $1,500 tuition incentive — $8,350 total, $7,600 balance after the deposit, on the same plans ($1,266.67 over 6 months or $950 over 8 months); verified with a military ID or DD214.",
        "Nada hasta que hayas hecho el recorrido: primero reserva una visita al campus. Luego tres etapas. Primero, una cuota de inscripción de $150, no reembolsable, que se paga en línea cuando hayas decidido inscribirte. Segundo, un depósito de cupo de $750 cuando tu solicitud y acuerdo de inscripción estén completos — eso es lo que reserva tu cupo, y tu inscripción de $150 se acredita, así que entonces se pagan $600. Tercero, el saldo de $9,100 en un plan interno sin intereses ($1,516.66 al mes por 6 meses o $1,137.50 al mes por 8 meses) o un plan de 18 meses a través de TFC Tuition Financing. Aceptamos tarjeta, ACH, cheque y efectivo. Los militares y primeros respondientes elegibles reciben un incentivo de matrícula de $1,500 — $8,350 en total, saldo de $7,600 después del depósito, en los mismos planes ($1,266.67 por 6 meses o $950 por 8 meses); se verifica con identificación militar o DD214.",
      ),
    },
    {
      q: b(
